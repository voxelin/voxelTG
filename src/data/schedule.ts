...
export const schedule: {
    [key: string]: Array<{ start: string; end: string; link: string | string[]; name: string; sent?: boolean }>;
} = {
    Monday: [
        ...
        { start: "11:15", end: "12:00", link: links.Chemistry, name: "🧪 Хімія (Код: 242295)" },
    ...
    Thursday: [
        ...
        { start: "13:05", end: "13:50", link: [links.EnglishA, links.EnglishB], name: "📚 Англійська" },
        {
            ...
            link: [links.Geography, links.History],
